...
var CoursesDetailsComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CoursesDetailsComponent, _super);
    function CoursesDetailsComponent(coursesService, router, route) {
        var _this = _super.call(this) || this;
        _this.coursesService = coursesService;
        _this.router = router;
        _this.route = route;
        return _this;
    }
    CoursesDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.subs = this.route.params.subscribe(function (params) {
            _this.activeCourse = _this.coursesService.getOne(+params.id);
        });
    };
    CoursesDetailsComponent.ctorParameters = function () { return [
...
}(src_app_shared_base_subscriptions_manager__WEBPACK_IMPORTED_MODULE_4__["SubscriptionsManager"]));
...
var CoursesComponent = /** @class */ (function (_super) {
    ...
    function CoursesComponent(coursesService, router, route) {
        var _this = _super.call(this) || this;
        _this.coursesService = coursesService;
        _this.router = router;
        _this.route = route;
    ...
    CoursesComponent.prototype.ngOnInit = function () {
        ...
        this.subs = this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                _this.courseSelected = !!_this.route.firstChild.snapshot.params.id;
            }
        });
    };
...
}(_shared_base_subscriptions_manager__WEBPACK_IMPORTED_MODULE_4__["SubscriptionsManager"]));
...
var SubscriptionsManager = /** @class */ (function () {
    function SubscriptionsManager() {
        // tslint:disable-next-line:variable-name
        this._subscriptions = [];
    }
    Object.defineProperty(SubscriptionsManager.prototype, "subs", {
        get: function () {
            return this._subscriptions;
        },
        set: function (sub) {
            if (sub && (sub instanceof rxjs__WEBPACK_IMPORTED_MODULE_1__["Subscription"])) {
    ...
    SubscriptionsManager.prototype.ngOnDestroy = function () {
        this.unsubscribeAll();
    };
    SubscriptionsManager.prototype.unsubscribe = function (sub) {
        var idx = this._subscriptions.indexOf(sub);
        if (idx >= 0) {
            this._subscriptions[idx].unsubscribe();
            this._subscriptions.splice(idx, 1);
        }
    };
    SubscriptionsManager.prototype.unsubscribeAll = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this._subscriptions), _c = _b.next(); !_c.done; _c = _b.next()) {
                var sub = _c.value;
                if (sub) {
                    sub.unsubscribe();
                }
...
var CoursesService = /** @class */ (function () {
    ...
    CoursesService.prototype.getOne = function (id) {
        return this.courses.find(function (elem) { return elem.id === id; });
    };
...
//# sourceMappingURL=src-app-courses-courses-module-es5.js.map