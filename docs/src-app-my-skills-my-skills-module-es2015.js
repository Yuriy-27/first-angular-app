...
let MySkillsComponent = class MySkillsComponent {
    constructor(mySkillsService) {
...
MySkillsComponent.ctorParameters = () => [
...
let MySkillsModule = class MySkillsModule {
};
...
let MySkillsService = class MySkillsService {
    constructor() {
        this.contactsInfo = [
            {
...
//# sourceMappingURL=src-app-my-skills-my-skills-module-es2015.js.map